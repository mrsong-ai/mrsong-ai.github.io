...
echo.
echo 🔄 正在重写Git历史...
git filter-branch --force --index-filter "git rm --cached --ignore-unmatch .well-known/validation-key.txt" --prune-empty --tag-name-filter cat -- --all
